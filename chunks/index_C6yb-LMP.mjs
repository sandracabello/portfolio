/* empty css                         */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, b as createAstro, d as addAttribute, e as renderHead, a as renderComponent, f as renderSlot } from './astro/server_C-ikqLv9.mjs';
import 'kleur/colors';
/* empty css                         */
...
const $$Astro$2 = createAstro("https://sandracabello.github.io/portfolio/");
...
const $$Astro$1 = createAstro("https://sandracabello.github.io/portfolio/");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const projects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./projects/project-1/content.md": () => import('./content_D3sRfFfN.mjs'),"./projects/project-2/content.md": () => import('./content_CVDSu7dC.mjs'),"./projects/project-3/content.md": () => import('./content_BKBtHgY5.mjs'),"./projects/project-4/content.md": () => import('./content_CoT4yRSp.mjs'),"./projects/project-5/content.md": () => import('./content_Bzzf6-Op.mjs'),"./projects/project-6/content.md": () => import('./content_DQgJzcon.mjs'),"./projects/project-7/content.md": () => import('./content_CY__luTO.mjs'),"./projects/project-8/content.md": () => import('./content_BdRfwpkI.mjs')}), () => "../pages/projects/**/*.md");
